            ...
            <div class="p-4">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-xl font-bold text-gray-900" data-stat="active_units"><?php echo e($stats['active_units']); ?></p>
            ...
            <div class="p-4">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-xl font-bold text-gray-900" data-stat="today_boundary"><?php echo e(formatCurrency($stats['today_boundary'])); ?></p>
            ...
            <div class="p-4">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-xl font-bold text-green-600" data-stat="net_income"><?php echo e(formatCurrency($stats['net_income'])); ?></p>
            ...
            <div class="p-4">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-xl font-bold text-gray-900" data-stat="maintenance_units"><?php echo e($stats['maintenance_units']); ?></p>
            ...
            <div class="p-4">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-xl font-bold text-gray-900" data-stat="active_drivers"><?php echo e($stats['active_drivers']); ?></p>
                    </div>
            ...
            <div class="p-4">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-xl font-bold text-gray-900" data-stat="avg_boundary"><?php echo e(formatCurrency($stats['avg_boundary'])); ?></p>
                    </div>
                    <div class="p-2 bg-green-100 rounded-full">
            ...
            <div class="p-4">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-xl font-bold text-gray-900" data-stat="coding_units"><?php echo e($stats['coding_units']); ?></p>
                    </div>
