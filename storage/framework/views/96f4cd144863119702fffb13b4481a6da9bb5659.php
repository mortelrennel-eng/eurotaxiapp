...
<body>
    ...
    <div class="split-layout flex h-screen">
        ...
        <div class="left-side w-full md:w-1/2 h-full relative overflow-hidden">
            <img src="<?php echo e(asset('uploads/1000053201.jpg')); ?>" alt="Eurotaxisystem" class="w-full h-full object-cover">
            ...
            <div class="absolute inset-0 frosted-overlay flex flex-col">
                ...
                <div class="text-center px-8 pt-16">
                    <div class="logo-container mx-auto logo-bounce">
                        <img src="<?php echo e(asset('uploads/logo.png')); ?>" alt="Eurotaxisystem Logo" class="logo-image">
                    </div>
                </div>
                            ...
                            <div class="form-panel forgot-panel">
                                ...
                                <div id="otpSection" style="display:none;">
                                    ...
                                    <div class="otp-inputs">
                                        <?php for($i = 0; $i < 6; $i++): ?>
                                            <input type="text" class="otp-input" maxlength="1" data-index="<?php echo e($i); ?>">
                                        <?php endfor; ?>
                                    </div>
