<?php $__env->startSection('title', 'Salary Management - Euro System'); ?>
<?php $__env->startSection('page-heading', 'Salary Management'); ?>
<?php $__env->startSection('page-subheading', 'Manage employee salaries and company expenses with monthly summaries'); ?>
...
<?php $__env->startSection('content'); ?>
            ...
            <div class="p-6">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-2xl font-bold text-blue-600"><?php echo e($summary['total_employees'] ?? 0); ?></p>
            ...
            <div class="p-6">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-2xl font-bold text-green-600"><?php echo e(formatCurrency($summary['total_salaries'] ?? 0)); ?></p>
            ...
            <div class="p-6">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-2xl font-bold text-red-600"><?php echo e(formatCurrency($summary['total_expenses'] ?? 0)); ?></p>
                        <p class="text-xs text-gray-500 mt-1">This month</p>
                    </div>
            ...
            <div class="p-6">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <?php $net = ($summary['net_profit'] ?? 0); ?>
                        <p class="text-2xl font-bold <?php echo e($net >= 0 ? 'text-green-600' : 'text-red-600'); ?>">
                            <?php echo e(formatCurrency($net)); ?>

                        </p>
                        <p class="text-xs text-gray-500 mt-1">After payroll</p>
                    </div>
                    <div class="p-3 <?php echo e($net >= 0 ? 'bg-green-100' : 'bg-red-100'); ?> rounded-full">
                        <i data-lucide="<?php echo e($net >= 0 ? 'trending-up' : 'trending-down'); ?>" class="h-8 w-8 <?php echo e($net >= 0 ? 'text-green-600' : 'text-red-600'); ?>"></i>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
        <div class="bg-white rounded-lg shadow p-6">
            ...
            <p class="text-xl text-green-600"><?php echo e(formatCurrency($summary['avg_salary'] ?? 0)); ?></p>
        </div>
        <div class="bg-white rounded-lg shadow p-6">
            <h3 class="font-semibold text-gray-700 mb-1">Average Expense/Employee</h3>
            <p class="text-xl text-red-600"><?php echo e(formatCurrency($summary['avg_expense'] ?? 0)); ?></p>
        </div>
    </div>
                    ...
                    <?php $__empty_1 = true; $__currentLoopData = $salaries; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $salary): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr class="hover:bg-gray-50">
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="text-sm font-medium text-gray-900"><?php echo e($salary->employee_name); ?></div>
                                <div class="text-xs text-gray-500"><?php echo e($salary->position ?? ''); ?></div>
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                                <?php echo e(ucfirst($salary->salary_type ?? 'Monthly')); ?>

                            </td>
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                                <?php echo e(formatCurrency($salary->basic_salary)); ?>

                            </td>
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                                <?php echo e(formatCurrency($salary->overtime_pay ?? 0)); ?>

                            </td>
                            <td class="px-6 py-4 whitespace-nowrap text-sm font-bold text-green-600">
                                <?php echo e(formatCurrency($salary->total_pay ?? $salary->basic_salary)); ?>

                            </td>
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                                <?php echo e(isset($salary->pay_date) ? \Carbon\Carbon::parse($salary->pay_date)->format('M d, Y') : '-'); ?>

                            </td>
                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                <button type="button" onclick="openEditSalaryModal(<?php echo e($salary->id); ?>)" class="text-blue-600 hover:text-blue-900 mr-2">
                                    <i data-lucide="edit" class="w-4 h-4"></i>
                                </button>
                                <form method="POST" action="<?php echo e(route('salaries.destroy', $salary->id)); ?>" class="inline"
    ...
    <div class="bg-white rounded-lg shadow overflow-hidden">
        ...
        <div class="overflow-x-auto">
            <table class="min-w-full divide-y divide-gray-200">
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    <?php $__empty_1 = true; $__currentLoopData = $expense_records ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $expense): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr class="hover:bg-gray-50">
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900"><?php echo e($expense->expense_type ?? '-'); ?></td>
                            <td class="px-6 py-4 text-sm text-gray-900"><?php echo e(Str::limit($expense->description, 40)); ?></td>
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900"><?php echo e($expense->category ?? '-'); ?></td>
                            <td class="px-6 py-4 whitespace-nowrap text-sm font-bold text-red-600"><?php echo e(formatCurrency($expense->amount)); ?></td>
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                                <?php echo e(isset($expense->expense_date) ? \Carbon\Carbon::parse($expense->expense_date)->format('M d, Y') : '-'); ?>

                            </td>
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                                <?php if(isset($expense->receipt_path) && $expense->receipt_path): ?>
                                    <a href="<?php echo e(asset('storage/' . $expense->receipt_path)); ?>" target="_blank" class="text-blue-600">View</a>
                                <?php else: ?>
                                    <span class="text-gray-400">None</span>
                                <?php endif; ?>
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                <form method="POST" action="<?php echo e(route('salaries.destroy', $expense->id)); ?>" class="inline"
    ...
    <div id="addSalaryModal" class="fixed inset-0 bg-gray-600 bg-opacity-50 hidden h-full w-full z-50 flex items-center justify-center p-4">
        <div class="relative bg-white rounded-lg shadow-xl max-w-lg w-full max-h-[90vh] overflow-y-auto">
            ...
            <form id="salaryForm" method="POST" action="<?php echo e(route('salaries.store')); ?>" class="p-6 space-y-4">
                <?php echo csrf_field(); ?>
                ...
                <div>
                    ...
                    <select name="employee_id" id="salaryEmployee" required
                        ...
                        <?php $__currentLoopData = $employees; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $employee): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($employee->id); ?>"><?php echo e($employee->full_name); ?> (<?php echo e(ucfirst($employee->role)); ?>)</option>
                ...
                <div class="grid grid-cols-2 gap-4">
                    <div>
                        ...
                        <select name="month" id="salaryMonth" required class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-yellow-500 focus:border-yellow-500">
                            <?php for($i = 1; $i <= 12; $i++): ?>
                                <option value="<?php echo e($i); ?>" <?php echo e($i == date('m') ? 'selected' : ''); ?>><?php echo e(date('F', mktime(0, 0, 0, $i, 1))); ?></option>
                            <?php endfor; ?>
                        </select>
                    </div>
                    <div>
                ...
                <div>
                    ...
                    <input type="date" name="pay_date" id="salaryPayDate" value="<?php echo e(date('Y-m-d')); ?>" required
    ...
    <div id="addExpenseModal" class="fixed inset-0 bg-gray-600 bg-opacity-50 hidden h-full w-full z-50 flex items-center justify-center p-4">
        <div class="relative bg-white rounded-lg shadow-xl max-w-lg w-full max-h-[90vh] overflow-y-auto">
            ...
            <form method="POST" action="<?php echo e(route('salaries.store')); ?>" enctype="multipart/form-data" class="p-6 space-y-4">
                <?php echo csrf_field(); ?>
    ...
    <div id="monthlyReportModal" class="fixed inset-0 bg-gray-600 bg-opacity-50 hidden h-full w-full z-50 flex items-center justify-center p-4">
        <div class="relative bg-white rounded-lg shadow-xl max-w-2xl w-full max-h-[90vh] overflow-y-auto">
            ...
            <div class="p-6" id="monthlyReportContent">
                <h4 class="text-md font-semibold text-gray-700 mb-4"><?php echo e(date('F Y')); ?> Summary</h4>
                <div class="grid grid-cols-2 gap-4 mb-6">
                    <div class="p-4 bg-green-50 rounded-lg">
                        <p class="text-sm text-gray-600">Total Employees</p>
                        <p class="text-xl font-bold text-green-700"><?php echo e($summary['total_employees'] ?? 0); ?></p>
                    </div>
                    <div class="p-4 bg-blue-50 rounded-lg">
                        <p class="text-sm text-gray-600">Total Salaries</p>
                        <p class="text-xl font-bold text-blue-700"><?php echo e(formatCurrency($summary['total_salaries'] ?? 0)); ?></p>
                    </div>
                    <div class="p-4 bg-red-50 rounded-lg">
                        <p class="text-sm text-gray-600">Total Expenses</p>
                        <p class="text-xl font-bold text-red-700"><?php echo e(formatCurrency($summary['total_expenses'] ?? 0)); ?></p>
                    </div>
                    <div class="p-4 <?php echo e(($summary['net_profit'] ?? 0) >= 0 ? 'bg-green-50' : 'bg-red-50'); ?> rounded-lg">
                        <p class="text-sm text-gray-600">Net Profit</p>
                        <p class="text-xl font-bold <?php echo e(($summary['net_profit'] ?? 0) >= 0 ? 'text-green-700' : 'text-red-700'); ?>">
                            <?php echo e(formatCurrency($summary['net_profit'] ?? 0)); ?>
...
function openAddSalaryModal() {
    ...
    document.getElementById('salaryForm').action = '<?php echo e(route('salaries.store')); ?>';
    ...
    document.getElementById('salaryPayDate').value = '<?php echo e(date('Y-m-d')); ?>';
    document.getElementById('salaryMonth').value = '<?php echo e(date('m')); ?>';
    document.getElementById('salaryYear').value = '<?php echo e(date('Y')); ?>';
...
function openEditSalaryModal(id) {
    ...
    document.getElementById('salaryForm').action = '<?php echo e(url('salaries')); ?>/' + id;
    document.getElementById('addSalaryModal').classList.remove('hidden');
    lucide.createIcons();
}
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\eurotaxisystem\resources\views/salary/index.blade.php ENDPATH**/ ?>