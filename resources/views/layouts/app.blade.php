                ...
                <div class="h-full flex flex-col">
                    ...
                    <nav class="flex-1 p-4 space-y-1 overflow-y-auto">
                        <a href="{{ route('dashboard') }}"
                            class="sidebar-item flex items-center gap-2.5 px-4 py-2 rounded-lg text-gray-700 hover:bg-yellow-50 hover:text-yellow-700 {{ request()->routeIs('dashboard') ? 'bg-yellow-50 text-yellow-700 font-semibold' : '' }}">
                            <i data-lucide="layout-dashboard" class="w-4 h-4"></i>
                            <span class="text-sm">Dashboard</span>
                        </a>

                        <a href="{{ route('units.index') }}"
                            class="sidebar-item flex items-center gap-2.5 px-4 py-2 rounded-lg text-gray-700 hover:bg-yellow-50 hover:text-yellow-700 {{ request()->routeIs('units.*') ? 'bg-yellow-50 text-yellow-700 font-semibold' : '' }}">
                            <i data-lucide="car" class="w-4 h-4"></i>
                            <span class="text-sm">Unit Management</span>
                        </a>

                        <a href="{{ route('driver-management.index') }}"
                            class="sidebar-item flex items-center gap-2.5 px-4 py-2 rounded-lg text-gray-700 hover:bg-yellow-50 hover:text-yellow-700 {{ request()->routeIs('driver-management.*') ? 'bg-yellow-50 text-yellow-700 font-semibold' : '' }}">
                            <i data-lucide="users" class="w-4 h-4"></i>
                            <span class="text-sm">Driver Management</span>
                        </a>

                        <a href="{{ route('live-tracking.index') }}"
                            class="sidebar-item flex items-center gap-2.5 px-4 py-2 rounded-lg text-gray-700 hover:bg-yellow-50 hover:text-yellow-700 {{ request()->routeIs('live-tracking.*') ? 'bg-yellow-50 text-yellow-700 font-semibold' : '' }}">
                            <i data-lucide="map-pin" class="w-4 h-4"></i>
                            <span class="text-sm">Live Tracking</span>
                        </a>

                        <a href="{{ route('decision-management.index') }}"
                            class="sidebar-item flex items-center gap-2.5 px-4 py-2 rounded-lg text-gray-700 hover:bg-yellow-50 hover:text-yellow-700 {{ request()->routeIs('decision-management.*') ? 'bg-yellow-50 text-yellow-700 font-semibold' : '' }}">
                            <i data-lucide="file-text" class="w-4 h-4"></i>
                            <span class="text-sm">Franchise</span>
                        </a>

                        <a href="{{ route('boundaries.index') }}"
                            class="sidebar-item flex items-center gap-2.5 px-4 py-2 rounded-lg text-gray-700 hover:bg-yellow-50 hover:text-yellow-700 {{ request()->routeIs('boundaries.*') ? 'bg-yellow-50 text-yellow-700 font-semibold' : '' }}">
                            <i data-lucide="dollar-sign" class="w-4 h-4"></i>
                            <span class="text-sm">Boundaries</span>
                        </a>

                        <a href="{{ route('maintenance.index') }}"
                            class="sidebar-item flex items-center gap-2.5 px-4 py-2 rounded-lg text-gray-700 hover:bg-yellow-50 hover:text-yellow-700 {{ request()->routeIs('maintenance.*') ? 'bg-yellow-50 text-yellow-700 font-semibold' : '' }}">
                            <i data-lucide="wrench" class="w-4 h-4"></i>
                            <span class="text-sm">Maintenance</span>
                        </a>

                        <a href="{{ route('coding.index') }}"
                            class="sidebar-item flex items-center gap-2.5 px-4 py-2 rounded-lg text-gray-700 hover:bg-yellow-50 hover:text-yellow-700 {{ request()->routeIs('coding.*') ? 'bg-yellow-50 text-yellow-700 font-semibold' : '' }}">
                            <i data-lucide="calendar" class="w-4 h-4"></i>
                            <span class="text-sm">Coding Management</span>
                        </a>

                        <a href="{{ route('driver-behavior.index') }}"
                            class="sidebar-item flex items-center gap-2.5 px-4 py-2 rounded-lg text-gray-700 hover:bg-yellow-50 hover:text-yellow-700 {{ request()->routeIs('driver-behavior.*') ? 'bg-yellow-50 text-yellow-700 font-semibold' : '' }}">
                            <i data-lucide="alert-triangle" class="w-4 h-4"></i>
                            <span class="text-sm">Driver Behavior</span>
                        </a>

                        <a href="{{ route('office-expenses.index') }}"
                            class="sidebar-item flex items-center gap-2.5 px-4 py-2 rounded-lg text-gray-700 hover:bg-yellow-50 hover:text-yellow-700 {{ request()->routeIs('office-expenses.*') ? 'bg-yellow-50 text-yellow-700 font-semibold' : '' }}">
                            <i data-lucide="receipt" class="w-4 h-4"></i>
                            <span class="text-sm">Office Expenses</span>
                        </a>

                        <a href="{{ route('salary.index') }}"
                            class="sidebar-item flex items-center gap-2.5 px-4 py-2 rounded-lg text-gray-700 hover:bg-yellow-50 hover:text-yellow-700 {{ request()->routeIs('salary.*') ? 'bg-yellow-50 text-yellow-700 font-semibold' : '' }}">
                            <i data-lucide="calculator" class="w-4 h-4"></i>
                            <span class="text-sm">Salary Management</span>
                        </a>

                        <a href="{{ route('analytics.index') }}"
                            class="sidebar-item flex items-center gap-2.5 px-4 py-2 rounded-lg text-gray-700 hover:bg-yellow-50 hover:text-yellow-700 {{ request()->routeIs('analytics.*') ? 'bg-yellow-50 text-yellow-700 font-semibold' : '' }}">
                        ...
                        <a href="{{ route('unit-profitability.index') }}"
                            class="sidebar-item flex items-center gap-2.5 px-4 py-2 rounded-lg text-gray-700 hover:bg-yellow-50 hover:text-yellow-700 {{ request()->routeIs('unit-profitability.*') ? 'bg-yellow-50 text-yellow-700 font-semibold' : '' }}">
                            <i data-lucide="trending-up" class="w-4 h-4"></i>
                            <span class="text-sm">Unit Profitability</span>
                        </a>

                        <a href="{{ route('staff.index') }}"
                            class="sidebar-item flex items-center gap-2.5 px-4 py-2 rounded-lg text-gray-700 hover:bg-yellow-50 hover:text-yellow-700 {{ request()->routeIs('staff.*') ? 'bg-yellow-50 text-yellow-700 font-semibold' : '' }}">
